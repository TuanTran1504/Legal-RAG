...
llm_generate = ChatOllama(model="llama3.1:8b", temperature=0)
...
# Initialize JSONLoader and load JSON documents
    ...
    embedding_model = HuggingFaceEmbeddings(
            model_name="maastrichtlawtech/legal-sentence-bert",
...
#                     loader = JSONLoader(
#                             file_path=file_path,
#                             jq_schema=".content",  # Adjust this to your schema if needed
#                             text_content=False,
#                         )
...
#                     for d in file_data:
#                         data.append(d)
#                     # data.append(file_data)  # Append the data to the `data` variable
...
def generate(state):
    ...
    generation = gpt_llm.invoke([HumanMessage(content=rag_prompt_formatted)])
